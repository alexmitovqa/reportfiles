      ...
      init: function () {
        e(".side-nav .side-nav-menu li a").on("click", function (n) {
          e(this).parent().hasClass("open")
            ...
            : (e(this)
              ...
              e(this)
                ...
                .children("a")
                .removeClass("open"),
              e(this).parent().parent().children("li.open").removeClass("open"),
              e(this)
                .parent()
                .children(".dropdown-menu")
          ...
          e(".sidenav-expand-toggler").on("click", function (n) {
            if (e(".side-nav-backdrop").length)
              e(".side-nav-backdrop").remove();
            else {
              e(".app").append('<div class="side-nav-backdrop"></div>');
            }
            e(".app").toggleClass("side-nav-expand"),
              n.stopPropagation(),
              e(".side-nav-backdrop").on("click", function (n) {
    ...
    var i = {
      init: function () {
        e(".quick-view-toggler").on("click", function (n) {
          if (e(".quick-view-backdrop").length)
            e(".quick-view-backdrop").remove();
          else {
            e(".app").append('<div class="quick-view-backdrop"></div>');
          }
          e(".app").toggleClass("quick-view-expand"),
            n.stopPropagation(),
            e(".quick-view-backdrop").on("click", function (n) {
    ...
    var i = {
      init: function () {
        e(".search-toggle").on("click", function (n) {
          e(".search-box, .search-input").toggleClass("active"),
            e(".search-input input").focus(),
            n.preventDefault();
        }),
          e(".search-input input").on("keyup", function () {
            e(this).val().length > 0
              ? e(".search-predict").addClass("active")
              : e(".search-predict").removeClass("active"),
              e(".serach-text-bind").html(e(this).val());
          });
      },
    };
    window.header = i;
      ...
      init: function () {
        e(".checkAll").on("click", function () {
          ...
          e("tbody :checkbox").on("click", function () {
            e(this).closest("tr").toggleClass("selected", this.checked),
              e(this)
                .closest("table")
                .find(".checkAll")
                .prop(
                  "checked",
                  e(this).closest("table").find("tbody :checkbox:checked")
                    .length ==
                    e(this).closest("table").find("tbody :checkbox").length
                );
          });
      },
    };
...
$(".test-item").click(function () {
  ...
  $(".test-content-detail .detail-body")
    .empty()
    .append(content.removeClass("d-none"));
        ...
        datasets: [
          {
            ...
            data: [
              statusGroup.passParent,
              statusGroup.failParent,
              statusGroup.fatalParent,
              statusGroup.errorParent,
              statusGroup.warningParent,
              statusGroup.skipParent,
            ],
            backgroundColor: [
              "#00af00",
              "#F7464A",
        ...
        datasets: [
          {
            borderColor: "transparent",
            data: [
              statusGroup.passChild,
              statusGroup.failChild,
              statusGroup.fatalChild,
              statusGroup.errorChild,
              statusGroup.warningChild,
              statusGroup.skipChild,
...
(function drawGrandChildChart() {
  if (
    $("#grandchild-analysis").length > 0 &&
    typeof statusGroup !== "undefined" &&
    statusGroup.grandChildCount > 0
  ) {
    var config = {
      type: "doughnut",
      data: {
        datasets: [
          {
            borderColor: "transparent",
            data: [
              statusGroup.passGrandChild,
              statusGroup.failGrandChild,
              statusGroup.fatalGrandChild,
              statusGroup.errorGrandChild,
              statusGroup.warningGrandChild,
              statusGroup.skipGrandChild,
...
(function drawEventsChart() {
  if (
    $("#events-analysis").length > 0 &&
    typeof statusGroup !== "undefined" &&
    statusGroup.eventsCount > 0
  ) {
    var config = {
      type: "doughnut",
      data: {
        datasets: [
          {
            borderColor: "transparent",
            data: [
              statusGroup.passEvents,
              statusGroup.failEvents,
              statusGroup.fatalEvents,
              statusGroup.errorEvents,
              statusGroup.warningEvents,
              statusGroup.skipEvents,
              statusGroup.infoEvents,
            ],
            backgroundColor: [
              "#00af00",
              "#F7464A",
